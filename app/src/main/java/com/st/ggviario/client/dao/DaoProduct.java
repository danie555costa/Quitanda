...
import static com.st.ggviario.client.controls.references.RData.CONV_MET_ID1;
import static com.st.ggviario.client.controls.references.RData.CONV_MET_ID2;
import static com.st.ggviario.client.controls.references.RData.CONV_VALUE1;
import static com.st.ggviario.client.controls.references.RData.CONV_VALUE2;
...
import static com.st.ggviario.client.controls.references.RData.MET_COD;
import static com.st.ggviario.client.controls.references.RData.MET_ID;
import static com.st.ggviario.client.controls.references.RData.MET_NAME;
import static com.st.ggviario.client.controls.references.RData.PROD_ID;
import static com.st.ggviario.client.controls.references.RData.PROD_MET_ID;
import static com.st.ggviario.client.controls.references.RData.PROD_NAME;
import static com.st.ggviario.client.controls.references.RData.SELL_MET_ID;
import static com.st.ggviario.client.controls.references.RData.SELL_PRICE;
import static com.st.ggviario.client.controls.references.RData.SELL_PROD_ID;
import static com.st.ggviario.client.controls.references.RData.SELL_QUANTITY;
import static com.st.ggviario.client.controls.references.RData.T_CONVERSION;
import static com.st.ggviario.client.controls.references.RData.T_PRODUCT;
import static com.st.ggviario.client.controls.references.RData.VER_METREAGE_PRODUCT;
import static com.st.ggviario.client.controls.references.RData.VER_PRODUTO_SELL;
import static com.st.ggviario.client.controls.references.RData.VER_SELLROULE;
